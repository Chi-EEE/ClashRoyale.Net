...
namespace ClashRoyale.Game.Logic.Types
{
    public partial class Projectile
    {
        ...
        {
            if (Vector2_Helper.CheckDistanceFromProjectileAndEntity(this.CurrentPosition, this.TargetPosition, this.ProjectileData.Radius, Target.Entity.EntityData.CollisionRadius))
            {
